📊 **Análisis de la Encuesta de Población Activa (EPA)**

Proyecto de análisis y visualización de datos realizado en **Microsoft Excel** a partir de microdatos de la **Encuesta de Población Activa (EPA) del Instituto Nacional de Estadística (INE).**
...
Descodificación de variables categóricas a partir de los códigos proporcionados por la EPA.
Creación de nuevas variables analíticas para facilitar el estudio de características como sexo, edad, comunidad autónoma, nacionalidad, formación y situación respecto al empleo.
...
Creación de métricas e indicadores clave (KPIs) para facilitar la interpretación de los resultados.
...
**Tablas dinámicas y gráficos →** análisis y visualización.
...
Los datos han sido tratados y transformados exclusivamente con fines de análisis, aprendizaje y visualización de información estadística.
